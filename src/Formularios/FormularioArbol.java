...
public class FormularioArbol extends javax.swing.JFrame {
 ArbolBinario ab = new ArbolBinario();
    ...
    private void pintaArbol(Graphics g, NodoDoble n, int x, int y,int xoff,int yoff,int nivel){
     if (n == null) return;
     ...
     pintaArbol(g, n.getPrev(), (int)(x - xoff), (y + yoff),xoff+nivel*2,yoff,nivel+1);
     pintaArbol(g, n.getNext(), (int)(x + xoff), (y + yoff),xoff-nivel*2,yoff,nivel+1);
}
