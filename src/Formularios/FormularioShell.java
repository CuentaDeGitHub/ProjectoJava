 ...
 * @author Chuy
 */
public class FormularioShell extends javax.swing.JFrame {
int[] arreglo;
int tamaño;
int minimo;
int maximo;
    ...
    /**
     * Creates new form FormularioShell
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioShell.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
