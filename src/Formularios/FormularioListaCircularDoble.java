 ...
 * @author Chuy
 */
public class FormularioListaCircularDoble extends javax.swing.JFrame {
    NodoDoble n;
    ListaCircularDoble miLista = new ListaCircularDoble();

    /**
     * Creates new form FormularioListaCircularDoble
     */
    public FormularioListaCircularDoble() {
        initComponents();
    }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        try{
            ...
            Escritor.Escribir(textolista, nombreDelArchivo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioListaCircularDoble.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
